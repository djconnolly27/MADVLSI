...
C {madvlsi/gnd.sym} 340 70 0 0 {name=l4 lab=GND}
...
C {devices/lab_pin.sym} 400 0 2 0 {name=l11 sig_type=std_logic lab=Vout}
C {devices/code_shown.sym} 460 80 0 0 {name=SPICE only_toplevel=false value=".tran 0.01n 1u
.save all"}
